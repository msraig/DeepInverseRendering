...
encoder_var_names = ['adobe_enc_0']#['encoder_1', 'encoder_2', 'encoder_3', 'encoder_4', 'encoder_5','batch_normalization']
decoder_var_names = ['adobe_dec_0']#['decoder_1', 'decoder_2', 'decoder_3', 'decoder_4', 'decoder_5']
...
def encoder(inputs):
    with tf.variable_scope('adobe_enc_0'):
        with tf.variable_scope("Encoder"):
            ...
            with tf.variable_scope("encoder_1"):
                ...
                output = batch_norm(output, training=False)
            ...
            for encoder_layer, out_channels in enumerate(layer_specs):
                with tf.variable_scope("encoder_%d" % (len(layers) + 1)):
                    ...
                    outputs = convolved
                    outputs = batch_norm(outputs, training=False)
...
def decoder(inputs, output_channels):
    with tf.variable_scope('adobe_dec_0'):
