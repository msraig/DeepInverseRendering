...
encoder_var_names = ['encoder_1', 'encoder_2', 'encoder_3', 'encoder_4', 'encoder_5','batch_normalization']
...
def encoder(inputs):
    with tf.variable_scope('adobe_enc_0'):
        ...
        output = layers[-1]
        output = tf.layers.batch_normalization(output, training=False,center=False,scale=False)
        return output
